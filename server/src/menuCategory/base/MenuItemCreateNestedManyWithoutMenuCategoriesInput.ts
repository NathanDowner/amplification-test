...
@InputType()
class MenuItemCreateNestedManyWithoutMenuCategoriesInput {
...
export { MenuItemCreateNestedManyWithoutMenuCategoriesInput as MenuItemCreateNestedManyWithoutMenuCategoriesInput };
