...
@InputType()
class MenuCategoryCreateNestedManyWithoutMenusInput {
...
export { MenuCategoryCreateNestedManyWithoutMenusInput as MenuCategoryCreateNestedManyWithoutMenusInput };
