...
@InputType()
class MenuCategoryCreateNestedManyWithoutMenuItemsInput {
...
export { MenuCategoryCreateNestedManyWithoutMenuItemsInput as MenuCategoryCreateNestedManyWithoutMenuItemsInput };
